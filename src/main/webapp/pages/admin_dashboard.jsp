                                    ...
                                    <div class="p-6 rounded-3xl bg-white/5 border border-white/5 flex items-center justify-between group hover:bg-white/10 transition-all reveal">
                                        <div class="flex items-center gap-6">
                                            ...
                                            <div class="space-y-1">
                                                ...
                                                <div class="text-[10px] text-text-dim uppercase font-bold tracking-widest">System_Access_ID: \${item.id}</div>
                                            </div>
                                        </div>
                                        <div class="flex gap-3 opacity-40 group-hover:opacity-100 transition-opacity">
                                            <button onclick="editAuthor(\${item.id}, '\${item.name.replace(/'/g, "\\'")}', '\${item.bio.replace(/'/g, "\\'")}')" class="w-12 h-12 rounded-2xl bg-black/40 border border-white/5 flex items-center justify-center hover:bg-accent/20 hover:text-accent transition-all" title="修改档案"><i data-lucide="edit-3" class="w-5 h-5"></i></button>
