    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
                ...
                <div class="flex items-center gap-10">
                    <a href="${pageContext.request.contextPath}/pages/index.jsp"
                        ...
                        <span class="text-2xl font-black font-heading tracking-tighter text-white">阅己<span
                                class="text-primary/80">YueJi</span></span>
                    </a>
                    ...
                    <nav class="hidden lg:flex items-center gap-8">
                        ...
                        <a href="${pageContext.request.contextPath}/pages/index.jsp?category=玄幻"
                            class="text-sm font-bold text-text-muted hover:text-white transition-colors">玄幻</a>
                        <a href="${pageContext.request.contextPath}/pages/index.jsp?category=悬疑"
                            class="text-sm font-bold text-text-muted hover:text-white transition-colors">悬疑</a>
                        <a href="${pageContext.request.contextPath}/pages/index.jsp?category=都市"
                            class="text-sm font-bold text-text-muted hover:text-white transition-colors">都市</a>

                        <c:if test="${sessionScope.user.role == 'admin'}">
                            <a href="${pageContext.request.contextPath}/pages/admin_dashboard.jsp"
                    ...
                    <c:choose>
                        ...
                        <c:otherwise>
                            <div class="flex items-center gap-4">
                                ...
                                <button onclick="location.href='${pageContext.request.contextPath}/pages/register.jsp'"
                                    class="btn-ultimate px-6 py-2.5 text-xs">
                                    开启旅程
                                </button>
                            </div>
                        </c:otherwise>
        ...
        <script>
            ...
            async function logout() {
                ...
                try {
                    const response = await fetch('${pageContext.request.contextPath}/auth/logout', { method: 'POST' });
                    if (response.ok) {
