        ...
        <%@ include file="header.jsp" %>
            ...
            <%@ include file="footer.jsp" %>
                ...
                <div class="standard-card group cursor-pointer" onclick="location.href='novel_detail.jsp?id=\${n.id}'">
                    ...
                    <div class="p-3">
                        <h4 class="font-bold text-slate-900 truncate mb-1 text-sm group-hover:text-blue-600 transition-colors">\${n.title}</h4>
